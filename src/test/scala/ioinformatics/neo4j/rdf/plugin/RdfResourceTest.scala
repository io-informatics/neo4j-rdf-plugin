 ...
 */
class RdfResourceTest extends FlatSpec with Matchers {
  ...
  "insertRdf" should
    ...
    // Given
    try {
      val server: ServerControls = TestServerBuilders.newInProcessBuilder.withExtension("/test", classOf[RdfResource])
